        ...
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
          <div className="card-body">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="space-y-3">
                 <div>
                    ...
                    placeholder="Enter Your Name"  {...register("name", { required: true })}/>
                    {errors.name && <span className='text-red-600 mt-2 text-md'>
                 ...
                 <div>
                    <label htmlFor="image" className="block mb-2 text-sm">Select Image</label>
                     ...
                     className="w-full border border-gray-500 px-2 py-3 rounded-md 
                    focus:outline-amber-800 bg-amber-50 text-gray-800" {...register("photo")}/>
                 </div>
                 <div>
                    ...
                    className="w-full border border-gray-500 px-2 py-3 rounded-md 
                    focus:outline-amber-800 bg-amber-50 text-gray-800"
                    placeholder="******" {...register("password", { required: true, validate: passwordValidation })}/>
                     {errors.password && <span className='text-red-600 mt-2 text-md'>
                      This password field is required</span>}
                 </div>
              </div>

              <div className="w-3/4 mx-auto mt-5">
                <button type="submit" className="rounded-md w-full
              bg-sky-700 py-3 text-white ">Sign Up</button>
              </div>
            </form>
           ...
           <div className="flex flex-col">
             <button className="disabled:cursor-not-allowed  flex justify-center  items-center 
